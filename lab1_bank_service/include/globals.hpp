...
namespace globals
{
    ...
    inline constexpr int TELLERS_NUMBER = 10;         // can be changed manually
    ...
    inline int customers_number = 0; // determined after the main thread read file
    ...
    inline const std::string CUSTOMER_THREAD_INFO_FILE_PATH = "../data/customer_thread_info.txt";
    inline const std::string TELLER_THREAD_INFO_FILE_PATH = "../data/teller_thread_info.txt";
